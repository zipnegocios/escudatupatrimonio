...
// Formas geográficas reales de los 50 estados (Alaska y Hawaii ya vienen
// como insets, como en cualquier mapa de EE.UU.). DC y Puerto Rico no
// tienen una forma visible a esta escala — se ofrecen aparte como chips
// debajo del mapa. Mismo patrón que icons.tsx: SVG a mano, sin librerías
// de mapas ni proyecciones en runtime.
  ...
  return (
    <div className="flex flex-1 min-h-0 flex-col gap-3">
      ...
      <div className="flex items-center justify-center rounded-xl border border-gold-border bg-gold-subtle px-4 py-2.5 min-h-[44px]">
        <span className="type-label" style={{ color: "var(--gold-text)" }}>
          {selectedState ? `Estado seleccionado: ${selectedState.name}` : "Tocá tu estado en el mapa"}
        </span>
      </div>
